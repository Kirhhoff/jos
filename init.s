...
.LBB4:
.LBB5:
	.stabs	"./inc/x86.h",132,0,0,.Ltext1
.Ltext1:
	.stabn	68,0,214,.LM15-.LFBB2
.LM15:
#APP
# 214 "./inc/x86.h" 1
	movl %ebp,%esi
...
.LBE5:
.LBE4:
	.stabs	"kern/init.c",132,0,0,.Ltext2
.Ltext2:
...
.LFB36:
	...
	movaps	%xmm7, 192(%rsp)
.L18:
	.stabn	68,0,85,.LM33-.LFBB4
.LM33:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,88,.LM34-.LFBB4
.LM34:
	leaq	224(%rsp), %rax
